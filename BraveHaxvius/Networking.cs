...
namespace BraveHaxvius
{
    public class Networking
    {
        ...
        public JObject SendPacket(Request request, List<JProperty> inputs)
        {
            ...
            var url = "https://v345lapis-tWmilEJnE.gumi.sg/lapisProd/app/php/gme/actionSymbol/";
            ...
            if (errorMsg != null)
            {
                var searchValue = errorMsg.ToString();
                var msg = Text.Texts.FirstOrDefault(t => t.Key == searchValue).Value;
